...
const TypeObject* GetMinimalHelloWorldObject()
{
    ...
    mst_message.common().member_type_id(*TypeObjectFactory::get_instance()->get_array_identifier("char", {20}, false));
...
const TypeObject* GetCompleteHelloWorldObject()
{
    ...
    cst_message.common().member_type_id(*TypeObjectFactory::get_instance()->get_array_identifier("char", {20}, true));
