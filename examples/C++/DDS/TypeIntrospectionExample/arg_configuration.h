...
struct Arg : public option::Arg
{
            ...
            bool msg)
    {
        if (option.arg != 0)
        {
            ...
            if (data_type != HELLO_WORLD_DATA_TYPE && data_type != DATA_POINT_XML_DATA_TYPE)
            {
                if (msg)
                {
                    print_error("Option '", option, "' only accepts <hw|xml> values\n");
                }
                return option::ARG_ILLEGAL;
            }
            return option::ARG_OK;
...
const option::Descriptor usage[] = {
    ...
    { DATA_TYPE, 0, "x", "type",                  Arg::DataType,
      ...
      "hw -> HelloWorld data type (one string and one integer) generated by FastDDSGen by XML "
      "xml -> DataPoint (2 float points) generated from an xml file."
    },
